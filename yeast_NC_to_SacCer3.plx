...
# Last updated: Nick Kent, 29th Mar 2022
# USAGE:- perl yeast_toSacCer3.plx
#
# This script takes NC format .sgr files from SAM2PartN_sgr and converts to chrI, chrII format for
# 2011, SacCer3 build of yeast genome.
# 
################################################################################
