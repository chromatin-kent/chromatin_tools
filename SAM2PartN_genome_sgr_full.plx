...
# create timestamped output folders using POSIX strftime.
#################################################################################
# USAGE:- perl SAM2PartN_genome_sgr_full.plx
#
# This script will take a SORTED* Bowtie 1 CPSA paired read alignment .sam format file and will 
# generate full genome.sgr files (all chromosomes concatenated) containing 3MA-smoothed read 
# mid-point frequency values for MNase-resistant chromatin particle reads.
#
...
#
# This script will NOT run on a weedy Laptop, but probably requires a high memory
...
print "\nThe following nuclease-protection/chromatin-particle sizes have been specified:\n ";
