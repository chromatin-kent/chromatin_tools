...
# USAGE:- perl SiteWriter_Full.plx
#
# FUNCTION:
...
# The input .txt files should have four columns: chrn; Site ID; site dyad pos; strand.
#
...
################################################################################
# Get site list and write info to arrays - from .txt format with four columns:
